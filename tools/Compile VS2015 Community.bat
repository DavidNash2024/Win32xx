...
MSBuild MovieShow\ProjectFiles\MovieShow_2015.sln /p:Configuration=Debug                 >>"..\output\VS2015.log"
MSBuild MovieShow\ProjectFiles\MovieShow_2015.sln /p:Configuration=Release               >>"..\output\VS2015.log"

...
devenv /build Debug MovieShow\ProjectFiles\MovieShow_2008.sln                 >>"..\output\VS2008.log"
devenv /build Release MovieShow\ProjectFiles\MovieShow_2008.sln               >>"..\output\VS2008.log"

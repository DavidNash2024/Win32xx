...
copy DLL\ProjectFiles\Debug\Test.exe                          "..\output\VS2005\Debug"    >>"..\output\VS2005.log"
...
copy DLL\ProjectFiles\Release\Test.exe                          "..\output\VS2005\Release"    >>"..\output\VS2005.log"

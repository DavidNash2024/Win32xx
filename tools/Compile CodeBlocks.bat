...
copy MovieShow\DLLs\x64\MediaInfo.dll                                       "..\output\MinGW\Debug"    >>"..\output\CodeBlocks.log"
...
copy MovieShow\DLLs\x64\MediaInfo.dll                                         "..\output\MinGW\Release"    >>"..\output\CodeBlocks.log"

...
copy ScintillaDemo\DLLs\x86\Scintilla.dll                         "..\output\MinGW\Debug"    >>"..\output\CodeBlocks.log"
...
copy ScintillaDemo\DLLs\x86\Scintilla.dll                           "..\output\MinGW\Release"    >>"..\output\CodeBlocks.log"

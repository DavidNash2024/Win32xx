...
copy DLL\ProjectFiles\Release\My.dll                            "..\output\VS2008\Release"    >>"..\output\VS2008.log"
copy DLL\ProjectFiles\Release\Test.exe                          "..\output\VS2008\Release"    >>"..\output\VS2008.log"

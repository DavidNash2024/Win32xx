...
MSBuild Round\ProjectFiles\Round_2010.sln /p:Configuration=Debug                         >>"..\output\VS2010.log"
MSBuild Round\ProjectFiles\Round_2010.sln /p:Configuration=Release                       >>"..\output\VS2010.log"

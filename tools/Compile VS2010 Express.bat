...
MSBuild BrowserATL\ProjectFiles\BrowserATL_2010.sln /p:Configuration=Debug               >>"..\output\VS2010.log"
MSBuild BrowserATL\ProjectFiles\BrowserATL_2010.sln /p:Configuration=Release             >>"..\output\VS2010.log"

...
//	ThemeToolbar tt = {T, RGB(255, 230, 190), RGB(255, 190, 100), RGB(255, 140, 40), RGB(255, 180, 80), RGB(192, 128, 255)};
	...
	tm.clrPressed1 = RGB(255, 140, 40);
	tm.clrPressed2 = RGB(255, 180, 80);
	tm.clrOutline  = RGB(192, 128, 255);

//	or you could use the following
//	ThemeMenubar tm = {T, RGB(255, 230, 190), RGB(255, 190, 100), RGB(255, 140, 40), RGB(255, 180, 80), RGB(192, 128, 255)};
	MB.SetTheme(tm);

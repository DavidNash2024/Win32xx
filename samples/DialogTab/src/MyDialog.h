...
private:
    CButtonDialog(const CButtonDialog&) = delete;
    CButtonDialog& operator=(const CButtonDialog&) = delete;
...
private:
    CComboBoxDialog(const CComboBoxDialog&) = delete;
    CComboBoxDialog& operator=(const CComboBoxDialog&) = delete;

...
// Called in resonse to the MG_CREATETAB message.
...
// Called in resonse to the MG_NAVIGATE message.
...
// Called in resonse to the MG_GOFORWARD message.
...
// Called in resonse to the MG_GOBACK message.
...
// Called in resonse to the MG_RELOAD message.
...
// Called in resonse to the MG_CANCEL message.
...
// Called in resonse to the MG_SWITCH_TAB message.
...
// Called in resonse to the MG_CLOSE_TAB message.
...
// Called in resonse to the MG_CLOSE_WINDOW message.
...
// Called in resonse to the MG_SHOW_OPTIONS message.
...
// Called in resonse to the MG_HIDE_OPTIONS message.
...
// Called in resonse to the MG_OPTION_SELECTED message.

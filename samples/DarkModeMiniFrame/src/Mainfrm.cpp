...
void CMainFrame::DrawBackground(CDC& dc)
{
...
{
    CFrame::OnSysColorChange(msg, wparam, lparam);
...
void CMainFrame::SetCaptionColors()
{
    ...
    if (IsDarkMode())
    {
        m_colors.inactive = RGB(30, 30, 30);
        m_colors.activeItem = RGB(255, 255, 255);          // text and max/min buttons
        m_colors.inactiveItem = RGB(180, 180, 180);        // text and max/min buttons
        m_colors.hover = RGB(64, 64, 64);
    }
    else
    {
        ...
        m_colors.activeItem = RGB(33, 33, 33);
        m_colors.inactiveItem = RGB(160, 160, 160);
...
void CMainFrame::SetDarkTheme()
{
    ...
    {
        MenuTheme mt = { t, RGB(30, 30, 30), RGB(30, 30, 30), RGB(40, 40, 40), RGB(40, 40, 40), RGB(96, 96, 96), RGB(180, 180, 180) };
        SetMenuTheme(mt);
    }
}
